module App
  class Server < Sinatra::Base
    ...
    get '/articles/:id' do
      ...
      @user = $db.exec_params("SELECT * FROM users WHERE id=$1", [ @article["user_id"] ]).first
      erb :article
    end
    ...
    patch '/articles/:id' do
      query = "UPDATE articles SET name=$1, content=$2, user_id=$3 WHERE id=$4"
      $db.exec_params query, [ params[:name], params[:content], params[:user_id], params[:id] ]
